...
def python3xBytesToStr():
    ...
    print("You should see these zh-CN unicode str in windows cmd normally: zhcnUnicodeStr = %s" % zhcnUnicodeStr)
    #You should see these zh-CN unicode str in windows cmd normally: zhcnUnicodeStr=1.此处的，Python 3.x中 ...... 然后再直接输出显示到windows的GBK编码的cmd中
