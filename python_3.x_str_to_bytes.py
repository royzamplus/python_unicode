...
def python3xStrToBytes():
    ...
    print("You should see these zh-CN bytes in windows cmd normally, which begin with b preffix: zhcnGbkBytes = %s" % (zhcnGbkBytes))
    #You should see these zh-CN bytes in windows cmd normally, which begin with b preffix: zhcnGbkBytes=b'1.\xb4\xcb\xb4\xa6\xb5 ...... \xc2\xeb\xb5\xc4cmd\xd6\xd0'
